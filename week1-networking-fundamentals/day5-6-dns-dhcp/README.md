...
### **Issue 2: DHCP Not Assigning IP**

**Symptoms:** Computer has APIPA address (169.254.x.x)
...
# Capture with Wireshark, look for DHCP Discover packets
# If no Offer received → DHCP server issue
```
